...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/Users/zhouxiaolun/miniob/build/bin/obclient")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/obclient" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      -delete_rpath "/Users/zhouxiaolun/miniob/build/src/obclient/../../lib"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/obclient")
    execute_process(COMMAND /usr/bin/install_name_tool
