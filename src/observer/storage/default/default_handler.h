...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname,  const CreateIndex *createIndex);
   ...
   * @return
   */
  RC insert_record(Trx * trx, const char *dbname, const char *relation_name, const Inserts *inserts);
